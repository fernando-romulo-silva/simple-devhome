...
echo "=============================================================================================================================="
echo "Set the environment for JDK 7-Dev (Jdk 7 with DCEVM-Full and HotswapAgent)"
...
# -----------------------------------------------------------------------------------------------------
# install java
. $DEVELOPMENT_HOME/scripts/internal/set-program.sh http://cdn-files.evildayz.com/mirror/java/jdk_7u79/jdk-7u79-linux-x64.tar.gz jdk7-dev languages/java JAVA_HOME

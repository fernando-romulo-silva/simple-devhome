...
# -----------------------------------------------------------------------------------------------------
# install maven
source ../internal/set-program.sh https://dlcdn.apache.org/maven/maven-3/3.9.11/binaries/apache-maven-3.9.11-bin.zip apache-maven-3.9 tools/apache-maven M2_HOME

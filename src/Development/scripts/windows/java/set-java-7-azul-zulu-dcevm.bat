...
call tar -xf %DEVELOPMENT_HOME%\tools\DCEVM\DCEVM-full-7\DCEVM-full-7.jar -C %JAVA_HOME%\jre\bin\server --strip-components 2 windows_amd64_compiler2/product/jvm.dll
